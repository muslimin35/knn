...
class Dashboard extends Member_Controller {
    ...
    public function index(){
        ...
        $data['all_user'] = $this->dashboard_model->count_all_user();
		$data['all_peserta'] = $this->dashboard_model->count_all_peserta(); 
		$data['all_soal'] = $this->dashboard_model->count_all_soal();
		$data['all_topic'] = $this->dashboard_model->count_all_topic();
		$data['tes'] = $this->dashboard_model->get_today_5_test();
        $dir1 = './public/uploads/';
        $dir2 = './uploads/';
