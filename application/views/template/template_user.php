...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Aplikasi Ujian  | <?php echo $title; ?></title>
        ...
        <nav class="navbar navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              <a href="<?php echo base_url(); ?>" class="navbar-brand"> <b>Aplikasi Ujian Online</b></a>
            </div>
			...
			<?php
				if(!empty($link_login_operator)){
					if($link_login_operator=='ya'){
						?>
							<strong> <a href="<?php echo site_url(); ?>/manager/" >Log In Admin</a></strong>
						<?php
					}
				}else{
					?>
